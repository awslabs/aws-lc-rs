...
extern "C" {
    #[link_name = "\u{1}_aws_lc_0_24_1_FIPS_is_entropy_cpu_jitter"]
...
extern "C" {
    #[link_name = "\u{1}_aws_lc_0_24_1_EVP_PKEY_CTX_pqdsa_set_params"]
...
extern "C" {
    #[link_name = "\u{1}_aws_lc_0_24_1_EVP_PKEY_pqdsa_new_raw_public_key"]
...
extern "C" {
    #[link_name = "\u{1}_aws_lc_0_24_1_EVP_PKEY_pqdsa_new_raw_private_key"]
...
extern "C" {
    #[link_name = "\u{1}_aws_lc_0_24_1_PKCS7_print_ctx"]
